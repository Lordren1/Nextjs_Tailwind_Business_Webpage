  ...
  return (
    <>
      <div className='hero h-screen w-full bg-midnight_text relative overflow-hidden pt-44 pb-20'>
        <div className="hero-image bg-[url(/images/hero/hero-bg.jpg)] absolute top-0 left-0 w-full 
        h-full bg-cover bg-no-repeat"></div>
        <div 
          className="shape-1 absolute z-30 top-0 left-0 w-[300px] h-auto flex
          justify-start items-start  
        ">
          <img src="/images/hero/pattern-2.svg" alt="element-image" />
        </div>
        <div 
          className="shape-2 absolute z-30 bottom-0 right-0 w-[300px] h-auto flex
        ...
        <div 
          ...
          >
            <div className="hero-content text-white">
              ...
              <Link
              href="/about"
              className="text-white bg-dark h-[50px] text-16 lg:text-sm w-fit rounded-full font-chakrapetch font-semibold flex gap-2 ps-4 py-2 justify-center items-center 
          ...
          {/* <div className="solution-b absolute lg:block hidden lg:bottom-5 bottom-0 lg:right-5 right-0 bg-white/10 backdrop-blur-sm p-8 max-w-md rounded-md z-10">
            <Icon
              icon="tdesign:quota-filled" width="60" height="60"
